...
# Read: $CLAUDE_PROJECT_DIR/docs/theme-profile.md (優先) または $CLAUDE_PROJECT_DIR/document/theme-profile.md (旧)
```
...
7. **`docs/theme-profile.md`（または旧 `document/theme-profile.md`）を必要に応じて参照**
